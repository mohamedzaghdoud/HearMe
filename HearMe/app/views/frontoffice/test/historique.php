        ...
        <div class="row">
            <div class="col-12">
                <div class="page-header text-center mb-5">
                    <h2> Mon Historique Émotionnel</h2>
                ...
                <div class="card mb-4 shadow">
                    <div class="card-header bg-gradient text-white" 
                         style="background: linear-gradient(135deg, #A7C7E7 0%, #B4E7B0 100%);">
                        <h5 class="mb-0">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-2 text-center">
                                    <div class="score-badge" style="width: 70px; height: 70px; 
                                         border-radius: 50%; 
                                         background: linear-gradient(135deg, #A7C7E7 0%, #B4E7B0 100%);
                ...
                <div class="card shadow">
                    <div class="card-body text-center py-5">
                        ...
                        <a href="?action=test" class="main-button">
                               Commencer le test
                        </a>
                    </div>
                </div>
                ...
                <!-- BOUTONS AVEC LE MÊME STYLE QUE LA PAGE ACCUEIL -->
                <div class="text-center mt-5">
                    <a href="?action=accueil" class="main-button me-3">
                         Retour à l'accueil
                    </a>
                    <a href="?action=test" class="main-button">
                         Refaire le test
...
/* Style des boutons identique à la page accueil */
.main-button {
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    borderColor: 'rgba(128, 189, 236, 1)',
                    borderWidth: 3,
                    tension: 0.4,
                    fill: true,
                    pointRadius: 6,
                    pointBackgroundColor: 'rgba(135, 233, 128, 1)',
                    pointBorderColor: '#fff',
                    pointBorderWidth: 2,
                    pointHoverRadius: 8,
                    pointHoverBackgroundColor: 'rgba(162, 232, 141, 1)',
            ...
            options: {
                ...
                plugins: {
                    ...
                    tooltip: {
                        ...
                        titleColor: '#fff',
                        bodyColor: '#fff',
                        borderColor: 'rgba(138, 177, 228, 1)',
                        borderWidth: 2,
                        padding: 15,
                        displayColors: false,
                        titleFont: {

<?php
/**
 * Model Question - Test Émotionnel
 */
class Question {
    private $id_question;
    private $id_quiz;
    ...
    public function setTexteQuestion($texte) { $this->texte_question = trim($texte); }
    public function setOrdre($ordre) { $this->ordre = max(1, (int)$ordre); }
